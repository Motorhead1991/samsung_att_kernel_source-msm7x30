...
/*
 * sec input bridge for apatch ramdump
 */
...
#ifdef CONFIG_INPUT_SECBRIDGE
static const struct sec_input_bridge_mkey apatch_mkey_map[] = {
...
static struct sec_input_bridge_platform_data apatch_input_bridge_data = {

    .mkey_map   = apatch_mkey_map,
    .num_mkey    = ARRAY_SIZE(apatch_mkey_map),
}; 

static struct platform_device apatch_input_bridge = {
    .name   = "samsung_input_bridge",
    .id     = -1,
    .dev    = {
        .platform_data = &apatch_input_bridge_data,
    },
};
#endif
...
static int __init lcdc_gpio_init(void) {

	int rc,n;
	int LCD_B[] = {20,21,22,100,101,102,103,104};
	
	rc = gpio_request(47, "LCD_SDA");
	if (rc) {
		pr_err("%s: unable to request gpio %d (%d)\n",
					__func__, 47, rc);
	}

	for (n = 0; n < sizeof(LCD_B)/sizeof(int); n++) {
		rc = gpio_request(LCD_B[n], NULL);
		if (rc) {
				pr_err("%s: unable to request gpio %d (%d)\n",
						__func__, LCD_B[n], rc);
		}
...
static struct msm_gpio lcd_panel_on_gpios[] = {
	 ...
	 GPIO_CFG(90, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA), /* pclk */
	 GPIO_CFG(91, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA), /* LCDC_EN */
	 GPIO_CFG(92, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA),/* vsync */
	 GPIO_CFG(93, 1, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA),/* hsync */
...
static struct msm_gpio lcd_panel_off_gpios[] = {
	 ...
	 GPIO_CFG(90, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA),/* pclk */
	 GPIO_CFG(91, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA),/* lcdc_en */
	 GPIO_CFG(92, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA),/* vsync */ 
	 GPIO_CFG(93, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA),/* hsync */
