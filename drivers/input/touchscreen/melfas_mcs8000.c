...
void mcs8000_touch_run(int pos_x, int pos_y, int pos_str)
{
	...
	input_report_abs(melfas_mcs8000_ts->input_dev, ABS_MT_POSITION_X, pos_x);
	input_report_abs(melfas_mcs8000_ts->input_dev, ABS_MT_POSITION_Y, pos_y);
	input_report_abs(melfas_mcs8000_ts->input_dev, ABS_MT_TOUCH_MAJOR, pos_str);
...
{
    input_report_key(melfas_mcs8000_ts->input_dev, keyevt, 1);
    mdelay(1);
    input_report_key(melfas_mcs8000_ts->input_dev, keyevt, 0);
}
#endif
